...
import React, { createContext, useContext, useState, ReactNode, useEffect } from 'react';
import {loginUser, logoutUser, fetchCurrentUser, registerUser, getUserFromLocalStorage} from '../Services/authService';
import {User} from "../Models/User";
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    const [user, setUser] = useState<{ username: string } | null>(getUserFromLocalStorage());
